...
class MessageType(str, Enum):
    ...
    FETCH_ARTIFACT_CHUNK = "fetch_artifact_chunk"
    FETCH_ARTIFACT_CHUNK_RESPONSE = "fetch_artifact_chunk_response"
    UPLOAD_ARTIFACT_CHUNK = "upload_artifact_chunk"
    UPLOAD_ARTIFACT_CHUNK_ACK = "upload_artifact_chunk_ack"
