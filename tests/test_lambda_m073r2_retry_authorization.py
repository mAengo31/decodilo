...
def test_m073r2_retry_authorization_is_future_only_after_clean_upload_closeout(tmp_path):
    ...
    auth = build_lambda_m073r2_retry_authorization_from_paths(
        upload_closeout=closeout,
        upload_policy=upload_policy,
        tiny_smoke_authorization=tiny_auth,
    )

    assert auth.authorization_status == "authorized_for_future_m073r2_tiny_smoke_retry"
